...
gsub("-", "", df.f15.1$sseqid) -> df.f15.1$sseqid
gsub("-", "", df.f15.1$gene) -> df.f15.1$gene
str_to_upper(df.f15.1$sseqid) -> df.f15.1$sseqid
...
df.f15.1$sseqid[df.f15.1$sseqid == "TEM217"] <- "TEM1"
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) + geom_gene_arrow(arrowhead_height = unit(7, "mm"), arrowhead_width = unit(1, "mm"), arrow_body_height = unit(7,"mm"), alpha = 0.5) +
  ...
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_discrete(name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c15
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  geom_gene_arrow(arrowhead_height = unit(7, "mm"), arrowhead_width = unit(1, "mm"), arrow_body_height = unit(7,"mm"), alpha = 0.5) +
    geom_blank(data = dummies1) +
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "right", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3), name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c27
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  ...
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.s12
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  ...
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c14
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  ...
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c9
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  geom_gene_arrow(arrowhead_height = unit(4, "mm"), arrowhead_width = unit(1, "mm"), arrow_body_height = unit(4,"mm"), alpha = 0.5) +
    geom_blank(data = dummies1) +
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c3
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  ...
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c16
...
ggplot(df.f15.1[order(df.f15.1$type, decreasing = T),], aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  ...
  facet_wrap(~ clust.id, scales = "free", ncol =1) + theme_genes() + 
  #theme(legend.position="none") +#  geom_gene_arrow(arrowhead_height = unit(5, "mm"), arrowhead_width = unit(1, "mm")) +
  geom_gene_label(align = "left", height = unit(30, "mm"), grow = TRUE, min.size = 4) + theme_genes() +  theme(legend.position = "bottom") + scale_fill_manual(values = hue_pal()(3),name = "", labels = c("AMR gene", "Insertion sequence (IS)", "Plasmid replicon") ) + ylab("") -> p.c1

ggarrange(p.c27, p.s12, nrow = 2, ncol = 1, heights = c(1,0.6), labels = c("A", "B")) -> contigs1.plot
...
ggarrange(p.c14, p.c9,  nrow = 2, ncol = 1, heights = c(0.71,1),labels = c("A", "B")) -> contigs.plot2

ggarrange( p.c3 , p.c16, p.c1, nrow = 3, ncol = 1, heights = c(1,1,1),labels = c("A", "B", "C")) -> contigs.plot3
...
```{r, wgs-within-vs-between-snpdist, echo = F, warning = F, message = F, fig.cap="Within and between participant pairwise SNP distances. A: Scatterplot of pairwise SNP distances as a function of time with GAM model fitted curve. B: Pairwise SNP distance as function of time as a 2D density plot, showing cluster of isolates close to origin that are close together in time and SNP-distance. C: Pairwsise SNP distance distribution before and after 50 days, within and between patients, showing statistically significant decrease in pairwise SNP distance within patients before 50 days. After 50 days, between- and within- patient distributuions are similar.", out.extra='', fig.scap="Within- and between pairwise SNP distance of isolates", fig.width = 8, fig.height = 5}
...
contigs %>% dplyr::group_by(Lane) %>% dplyr::mutate(id = paste0("contig", row_number())) -> contigs
...
apply(dplyr::select(crossall, Lane.x, Lane.y), 1, function(x) paste(sort(x), collapse = "")) -> crossall$key
...
crossall %>% dplyr::group_by(same_pt) %>% dplyr::summarise(same_hierb.only = sum(same_hierb == TRUE & same_contig == FALSE),
                                             ...
                                             tots = dplyr::n()) %>% dplyr::filter(!is.na(same_pt)) -> crossall.sum
...
df.m$variable[df.m$variable == "same_hierb.only"] <- "Same hierBAPS-cluster only"
...
df.m$variable <- factor(df.m$variable, levels = rev(c("Same ESBL and hierBAPS cluster","Same ESBL-cluster only" ,"Same hierBAPS-cluster only", "neither"  )))
...
```{r wgs-contig-ggenes-plot0, echo = F, warning = F, message = F, fig.scap="AMR genes, IS and plasmid replicon content of ESBL-clusters, \\textit{blaCTXM15}", out.extra='', fig.cap="AMR genes, insertion sequences (IS) and plasmid replicons identified in the representative contig of each contig cluster, for \\textit{blaCTXM15} containing contigs, ordered by number of samples of cluster from most (top) to least (bottom). IS\\textit{26} is very frequently associated with a 108bp fragment of \\textit{catB4} chloramphenicol resistance gene, shown as a red fragment within the green IS\\textit{26} element. Plots show furthest IS/AMR gene or plasmid replicon up to +/- 10,000bp from the ESBL gene of interest.", fig.width = 12, fig.height = 8.5}
...
```{r wgs-contig-ggenes-plot1, echo = F, warning = F, message = F, fig.scap="AMR genes, IS and plasmid replicon content of ESBL-clusters, \\textit{blaCTXM27} and \\textit{blaSHV12}.", out.extra='', fig.cap="AMR genes, insertion sequences (IS) and plasmid replicons identified in the representative contig of each contig cluster for \\textit{blaCTXM27} (A) and \\textit{blaSHV12} (B). Ordered by number of samples of cluster from top (largest) to bottom (smallest) for each ESBL gene. IS\\textit{26} is very frequently associated with a 108bp fragment of \\textit{catB4} chloramphenicol resistance gene, shown as a red fragnemt within the green IS\\textit{26} element. Plots show furthest IS/AMR gene or plasmid replicon up to +/- 10,000bp from the ESBL gene of interest.", fig.width = 12, fig.height = 5.5}

contigs1.plot

```

```{r wgs-contig-ggenes-plot2, echo = F, warning = F, message = F, fig.cap="AMR genes, insertion sequences (IS) and plasmid replicons identified in the representative contig of each contig cluster for  \\textit{blaCTXM14} (A) and \\textit{blaCTXM9} (B), ordered by number of samples in cluster from most (top) to least (bottom). IS\\textit{26} is very frequently associated with a 108bp fragment of \\textit{catB4} chloramphenicol resistance gene, shown as a red fragnemt within the green IS\\textit{26} element. Plots show furthest IS/AMR gene or plasmid replicon up to +/- 10,000bp from the ESBL gene of interest.", out.extra='', fig.scap="AMR genes, IS and plasmid replicon content of ESBL-clusters: \\textit{blaCTXM14} and \\textit{blaCTXM9}.", fig.width = 12, fig.height = 7}

contigs.plot2

```

```{r wgs-contig-ggenes-plot3, echo = F, warning = F, message = F, fig.cap="AMR genes, insertion sequences (IS) and plasmid replicons identified in the representative contig of each contig cluster for  \\textit{blaCTXM3} (A) and \\textit{blaCTXM16} (B) and \\textit{blaCTXM1} (C) , ordered by number of samples in cluster from most (top) to least (bottom). IS\\textit{26} is very frequently associated with a 108bp fragment of \\textit{catB4} chloramphenicol resistance gene, shown as a red fragnemt within the green IS\\textit{26} element. Plots show furthest IS/AMR gene or plasmid replicon up to +/- 10,000bp from the ESBL gene of interest.", out.extra='', fig.scap="AMR genes, IS and plasmid replicon content of ESBL-clusters: \\textit{blaCTXM16}, \\textit{blaCTXM3} and \\textit{blaCTXM3}.", fig.width = 12, fig.height = 5.5}
