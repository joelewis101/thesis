...
To address the concern that a model with so many parameters might be overfit, I performed dimensionality reduction with FAMD and refit the models using transformed predictor variables. As might be expected in absolute terms the out of sample predictive accuracy (as measured by ELPD) improved, but by an amount much less than the error in the estimation of ELPD. This supports the inferences from the original model.
