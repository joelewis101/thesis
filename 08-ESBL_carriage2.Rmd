...
Next, I explored the dynamics of carriage of ESBL-E species and _E. coli_ genotype, by refitting model 2 but considering the colonised/uncolonised states to be, in turn, presence or absence of _E. coli_, _K. pneumoniae_ or any of the top six most prevalent _E. coli_ genotypes (as defined by the combination of ESBL containing contig cluster and _E. coli_ hierBAPS cluster [Chapter xx]), and refitting the model for each one. All 993 within-participant sample-pair comparisons were used to fit the _E. coli_ and _K. pneumoniae_ models, but because sample collection continued after the sequenced _E. coli_ were shipped, all samples collected after this time were excluded. 585 samples from 251 participants were therefore included in the genotype models.
