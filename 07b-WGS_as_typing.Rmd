...
1. To use clustering algorithms to classify clusters of bacteria and mobile genetic elements (MGE) that can be used in further analyses to track bacteria and MGE within participants and associations between bacteria and MGE and metadata.
