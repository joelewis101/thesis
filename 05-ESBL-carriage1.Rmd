...
exposures %>% select(name, arm,n.p, exp.str, tr.len.str) %>%
  pivot_wider(names_from = arm, 
              ...
              values_fill= list(n.p = 0, exp.str = "0 (0%)", tr.len.str = "-")) -> exp.tab
