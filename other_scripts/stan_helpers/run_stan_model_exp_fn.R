...
fit <- stan(stan_model, data = stan_data, warmup = 500, iter = 1000, chains = 4, cores = 4, thin = 1)
saveRDS(fit_gamma,"/Users/joelewis/Documents/PhD/R/PhD/stan/final_interim_analysis/stan_model_real_data_exp_fn_loglik.rda" )
