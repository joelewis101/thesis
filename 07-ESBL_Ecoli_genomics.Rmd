...
orgs.cip <- orgs.cip[order(orgs.cip$`Phenotypic resistance`, orgs.cip$GyrA83, orgs.cip$GyrA87, orgs.cip$ParC80, orgs.cip$ParE458, orgs.cip$Qnr, orgs.cip$Qep),]
#dev.off()
