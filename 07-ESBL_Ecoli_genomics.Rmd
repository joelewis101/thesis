...
```{r wgs-qc, echo = F, warning = F, message = F, fig.scap="N50 as a function of total assembly length for included assemblies", out.extra='', fig.cap= "N50 as a function of total assembled length. Failed assemblies with less than 1Mb assembled shown as triangles. Contaminated assemblies with checkM-defined contamination above 25\\% shown in blue." }
