...
```{r wgs-amr-sum, echo = F, warning = F, message = F, fig.scap="AMR", out.extra='', fig.cap="AMR", fig.height = 10, fig.width=8}
...
amr.melt$class[grepl("Par", amr.melt$variable) | 
                 ...
                 grepl("Oqx", amr.melt$variable)] <- "Quinolone"
