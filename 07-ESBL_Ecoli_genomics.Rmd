...
ggtree(tree, size = 0.3) %>% 
 ...
 # gheatmap(select(metadata, malawi), width = 0.04, color = NA, font.size = 4, colnames_angle = 90,
  ...
  geom_cladelabel(node = 1864, label = "ST410", fontsize = 2.5) -> p #, labels = c("0", "1","A","B1","B2","C","Clade I or II", "D","F", 
...
```{r wgs-131vs410-tree, echo = F, warning = F, message = F, fig.scap="Phylogeny of ST131 and ST410 \\textit{E. coli}.", out.extra='', fig.cap="Subtree of ST410 (A, left) and ST131 (B, right), showing multiple introductions of ST131 into Malawi, in comparison to a single introduction of a clonal ST410 clade. Colour of tree tip label indicates isolation from this study (red) or other studies (black), and coloured heatmap indicates country of isolation. Scale bar indicates 0.0003 SNPs/site.", fig.height = 4, fig.width=6}
