...
116/473 (25%) of isoltes contained plasmid-mediated quinolone resistance genes, either $qnr$ or $qep$. 

```{r wgs-amr-sum, echo = F, warning = F, message = F, fig.scap="Frequency distribution of AMR genes", out.extra='', fig.cap="A: Frequency distribution of AMR genes identified in isolates. Class of antimicrobial to which gene confers resistance is shown. B: Frequency distribution of class resistance of isolates, based on presence of AMR gene. C: Phenotypic resistance patterns for subset of samples in this analysis that also underwent phenotypic testing (n = 440)", fig.height = 10, fig.width=8}
