...
#g3 <- graph_from_data_frame(jtots3[1:3], directed = F)
...
```{r wgs-amr-cooccur-plot, echo = F, warning = F, message = F, fig.scap="Co-occurance and lineage asociation of AMR genes", out.extra='', fig.cap="A:  Row and column clustered heatmap of pairwise Jaccard index matrix, showing clustering of AMR genes to compare co-occurance of AMR genes". B: Networks of commonly occuring (jaccard index > 0.5) and significantly co-occuring (p < 0.05, Bonferroni corrected) AMR genes. C: AMR genes mapped back to midpoint rooted maximum likelihood phylogenetic tree, showing lineage associations of genes.", fig.width = 11, fig.height = 14}
