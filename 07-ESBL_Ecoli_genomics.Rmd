...
```{r wgs-contig-ggenes, echo = F, warning = F, message = F, fig.scap="Plots of ESBL-clusters", out.extra='', fig.cap="Plots of ESBL-clusters", fig.width = 13, fig.height = 10}
...
ggplot(df.f15.1, aes(xmin = qstart, xmax = qend, y = clust.id, fill = type, label = sseqid, forward = direc)) +
  geom_gene_arrow() +
  ...
  geom_gene_label(align = "left") + theme_genes() +  theme(legend.position = "bottom")
