...
```{r outcome-morbidity, echo =F, warning=F, message=F,fig.scap="Kaplan-Meier survival curves.", out.extra='', fig.cap="Kaplan-Meier survival curves of all included participants (A) and stratified by HIV status (B). Crosses indicate censoring. p value from log-rank test comparing survival of HIV-infected to HIV-noninfected participants shown (p = 0.03).", fig.width= 8, fig.height =4, }
