...
155 participants were eligible for urinary lipoarabinomannan (uLAM) and mycobacterial blood culture testing, being either HIV-infected (n=143) or of unknown HIV status (n=12). Urine was available for 145/155 (94%) of those eligible, and 74/145 (51%) of samples were positive for uLAM. 154/155 (99%) eligible participants had blood samples collected and cultured for mycobacteria. 12/154 (8%) grew contaminents and are excluded from the denominators in Table \@ref(tab:sep-tests); of the remainder 8/138 (6%) grew mycobacteria, all _M. tuberculosis_.
...
```{r sep-bc-plot, echo = F, warning = F, message = F, fig.scap="Pathogenic isolates recovered from aerobic blood culture.", out.extra='', fig.cap="Pathogenic isolates recovered from aerobic blood culture. 25 blood cultures in 24 participants  were positive for 27 pathogens in total", fig.width = 7, fig.height = 2.3, out.height= "70%"}
