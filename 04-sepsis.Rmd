...
ggarrange(ggarrange(NULL,p.diag,NULL,NULL, ncol = 4, widths = c(0.25,1.5,0.25, 0.5), labels = c(NA, "A", NA, NA)), ggarrange(fluid1, fluid2, widths = c(1, 1.5), ncol = 2, labels = c("B", "C")), ggarrange(t_to_ab, t_to_ab2,NULL, ncol = 3, labels = c("D", "E"), widths = c(1,1,0.5)), ggarrange(t_to_tb, t_to_fung, NULL, labels = c("F", "G"), ncol = 3,widths= c(1,1,0.5) ), ncol = 1, nrow = 4)
