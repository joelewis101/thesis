...
```{r esbl-invasive-ssa-enzymes, echo = F, warning = F, fig.cap= "Disribution of beta-lactamase genes in invasive ESBL producing \\textit{E. coli} (n= 821) and \\textit{K. pneumoniae} (n = 791) from 10 studies", fig.align= "center", fig.height= 4, fig.width = 5}
...
```{r esbl-carriage-ssa-prev, echo = F, warning = F, fig.cap= "ESBL-E gut mucosal carriage in sSA. A: included studies by country; B: forest plot of ESBL-E carriage prevalence stratified by population. Pooled random effect summary estimates shown.", fig.align= "center", fig.height= 9, fig.width = 10}
...
```{r esbl-carriage-ssa-enzymes, echo = F, warning = F, fig.cap= "Distribution of beta-lactamase genes in carriage ESBL producing \\textit{E. coli} (n= 996) and \\textit{K. pneumoniae} (n = 607) from 9 studies.", fig.align= "center", fig.height= 4, fig.width = 5}
