...
knitr::kable(t2, output, booktabs = T, longtable = T, caption = "Search terms for fever studies") %>%
...
t8 <- read.csv(paste0(wd, "t8_bsi_isolates.csv"), check.names = F)
...
```{r esbl-invasive-ssa-enzymes, echo = F, warning = F,  fig.scap="ESBL genes in invasive ESBL-E in sSA", out.extra='',fig.cap= "Disribution of beta-lactamase genes in invasive ESBL producing \\textit{E. coli} (n= 821) and \\textit{K. pneumoniae} (n = 791) from 10 studies", fig.align= "center", fig.height= 3, fig.width = 5}
...
t13 <- read.csv(paste0(wd, "t13_ssa_invasive_ESBL_results.csv"), check.names = F)
